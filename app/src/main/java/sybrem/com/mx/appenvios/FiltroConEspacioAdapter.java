 ...
 * the data item.
 */
public class FiltroConEspacioAdapter<T> extends BaseAdapter implements
        Filterable {
    /**
     ...
     */
    public FiltroConEspacioAdapter(Context context, int textViewResourceId) {
     ...
     *            populated
     */
    public FiltroConEspacioAdapter(Context context, int resource,
     ...
     */
    public static FiltroConEspacioAdapter<CharSequence> createFromResource(
            Context context, int textArrayResId, int textViewResId) {
        CharSequence[] strings = context.getResources().getTextArray(
                textArrayResId);
        return new FiltroConEspacioAdapter<CharSequence>(context, textViewResId,
                strings);
    }
